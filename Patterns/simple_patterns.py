...
class SimplePatterns:
    ...
    def http_error(self, status: int)-> str:
        ...
        match status:
            ...
            case 401 | 403 : return 'Not Allowed' # Here '|' represents
    ...
    def location(self, point: Point | None) -> None:
        ...
        match point:
            ...
            case Point(x=0, y=y_val): print(f"Y={y_val} and the point is on y axis")
            case Point(x=x_val, y=0): print(f"X={x_val} and the point is on x axis")
