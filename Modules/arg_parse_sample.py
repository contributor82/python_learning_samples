...
class ArgParseSample: 
    ...
    def add_adv_combine_positional_option_argument(self): 
        ### Function to combine positional and optional argument ### 
        try: 
    ...
    def add_mutually_exclusive_group_argument(self): 
        ### Function to add arguments for mutually exclusive group ### 
        try:
            mutually_exclusive_group = self.parser.add_mutually_exclusive_group()
            mutually_exclusive_group.add_argument("-v", "--verbose", help="increase output verbosity", action="count")
            mutually_exclusive_group.add_argument("-q", "--quiet", help="quiet", action="count")
