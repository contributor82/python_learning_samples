...
class StatFuncMeasuresOfSpread:
    ...
    def population_std_deviation_of_data(self, input_data: list[int | float], mean_of_data: int | None = None) -> int | float:
        ### Returning the population of standard deviation ###
        return pstdev(input_data, mean_of_data)

    def variance_of_data(self, input_data: list[int | float], mean_of_data: int | None = None) -> int | float:
    ...
    def population_variance_of_data(self, input_data: list[int | float], mean_of_data: int | None = None) -> int | float:
