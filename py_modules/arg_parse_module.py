"""Module for argparse for building command line interface"""

import argparse


class ArgParseModule:
    """ Class for Argument Parser Module from Python doc """
...
if __name__ == '__main__':
    arg_parse_module_instance = ArgParseModule()
    # arg_parse_module_instance.add_new_argument()
    # OR following line for optional argument
    # arg_parse_module_instance.add_optional_argument()
    # OR following line for positional argument
    # arg_parse_module_instance.add_positional_argument()
    # OR following line since combining arguments
    # arg_parse_module_instance.add_combine_positional_optional_argument()
    # OR following line with more advance argument combination
    # arg_parse_module_instance.add_adv_combine_positional_option_argument()
    # OR following line with mutually exclusive group argument
    arg_parse_module_instance.add_mutually_exclusive_group_argument()
