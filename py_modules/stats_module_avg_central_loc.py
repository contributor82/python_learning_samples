...
class StatsModuleAvgCentralLocations:
    """ Statistics module functions of average & measures of central location """
    ...
    def median_of_data(self, input_data: list[float]) -> float:
        ...
        # Returns the middle value of the data values
...
if __name__ == '__main__':
    sm_avg_central_loc_instance = StatsModuleAvgCentralLocations()
    sample_data: list [float] = [20.7, float('NaN'), 19.2, 18.3, float('NaN'), 14.4] # type: ignore
    print('data elements : ', sample_data)
    print('sorted data : ', sm_avg_central_loc_instance.sort_data(sample_data))
    print('median of data : ', sm_avg_central_loc_instance.median_of_data(sample_data))
    clean_data: list[float] = sm_avg_central_loc_instance.strip_nan_values(sample_data)
    print('strip NaN values from input_data:  ', clean_data)
    print('Sorted clean input_data:  ', sm_avg_central_loc_instance.sort_data(clean_data))
    print('mean of data : ', sm_avg_central_loc_instance.mean_of_data(clean_data)) # type: ignore
    ...
    print('mean of fraction data : ',
          sm_avg_central_loc_instance.mean_of_data(fraction_input_data))
    ...
    print('mean of decimal data : ',
          sm_avg_central_loc_instance.mean_of_data(decimal_input_data))

    print('Fast, floating arithmatic mean of data : ',
          sm_avg_central_loc_instance.fmean_of_data(clean_data))
    ...
    print('harmonic mean of data : ', sm_avg_central_loc_instance.harmonic_mean_of_data(
        car_speed_in_kmhr, distance_traveled_in_km))

    print('geometric mean of data : ',
          sm_avg_central_loc_instance.geometric_mean_of_data(clean_data))

    print('median high of data : ',
          sm_avg_central_loc_instance.median_high_of_data(clean_data))

    print('median low of data : ',
          sm_avg_central_loc_instance.median_low_of_data(clean_data))

    print('median grouped of data : ',
          sm_avg_central_loc_instance.median_grouped_of_data(clean_data))
    ...
    print('mode of numeric input_data: ',
          sm_avg_central_loc_instance.stat_mode(numeric_data_elements))
    ...
    print('mode of alphabetic data elements: ',
          sm_avg_central_loc_instance.stat_mode(alphabetic_data_elements))

    alphabetic_multidata_elements: str = 'aabbccdddddeeeeefffffg'
    print('Numeric multidata elements: ', alphabetic_multidata_elements)
    print('mode of input_data: ', sm_avg_central_loc_instance.stat_multimode(
    ...
    result: list[float] = [round(q, 1) for q in
                           sm_avg_central_loc_instance.stat_quantiles(quantile_sample_data,
                                                               10, 'exclusive')]
