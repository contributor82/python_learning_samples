...
class StatModuleInputRelations:
    """Statistics module functions Input relations  """
...
if __name__ == '__main__':
    sm_rel_btn_inputs_instance = StatModuleInputRelations()
    ...
    print(' Covariance of X & Y: ',
          sm_rel_btn_inputs_instance.covariance_of_data(covariance_input_x, covariance_input_y))
    ...
    print(' Correlation of X & Y: ',
          sm_rel_btn_inputs_instance.correlation_of_data(correlation_input_x, correlation_input_y))
    ...
    slope, intercept = sm_rel_btn_inputs_instance.linear_regression_of_data(
