...
class StatModuleMeasuresOfSpread:
    """ Statistics module functions class for measures of spread """
...
if __name__ == '__main__':
    sm_measure_of_spread_instance = StatModuleMeasuresOfSpread()
    ...
    print('population of standard deviation outcome: ',
          sm_measure_of_spread_instance.population_std_deviation_of_data(sample_data))

    sample_data = [2.75, 1.75, 1.25, 0.25, 0.5, 1.25, 3.5]
    print('Input data for variance : ', sample_data)
    print('variance of data: ',
          sm_measure_of_spread_instance.variance_of_data(sample_data))

    sample_data = [0.25, 0.75, 0.35, 0.45, 0.50]
    print('Input data for population of variance : ', sample_data)
    print('population of standard deviation outcome: ',
          sm_measure_of_spread_instance.population_variance_of_data(sample_data))
