...
if __name__ == '__main__':
    qc_instance = QueueCreation()
    qc_instance.init_queue(10)

    qc_instance.append_fifo_queue('Fifo Element 1')
    qc_instance.append_fifo_queue('Fifo Element 2')
    qc_instance.append_fifo_queue('Fifo Element 3')
    qc_instance.append_fifo_queue('Fifo Element 4')

    qc_instance.append_lifo_queue('Lifo Element 1')
    qc_instance.append_lifo_queue('Lifo Element 2')
    qc_instance.append_lifo_queue('Lifo Element 3')
    qc_instance.append_lifo_queue('Lifo Element 4')

    qc_instance.append_priority_queue('Priority Element 1')
    qc_instance.append_priority_queue('Priority Element 2')
    qc_instance.append_priority_queue('Priority Element 3')
    qc_instance.append_priority_queue('Priority Element 4')

    qc_instance.append_simple_queue('Simple Element 1')
    qc_instance.append_simple_queue('Simple Element 2')
    qc_instance.append_simple_queue('Simple Element 3')
    qc_instance.append_simple_queue('Simple Element 4')

    print(' fifo queue element: ', qc_instance.get_fifo_queue_element())
    print(' lifo queue element: ', qc_instance.get_lifo_queue_element())
    print(' priority queue element: ', qc_instance.get_priority_queue_element())
    print(' simple queue element: ', qc_instance.get_simple_queue_element())
    print(' simple queue size: ', qc_instance.get_simple_queue_size())

    qc_instance.display_fifo_queue()
    qc_instance.display_lifo_queue()
    qc_instance.display_priority_queue()
    qc_instance.display_simple_queue()
