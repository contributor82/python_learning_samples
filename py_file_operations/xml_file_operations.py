...
if __name__ == '__main__':
    ...
    node_occurs: list[Element] = xml_file_ops_instance.get_node_occurrences(
    ...
    print('HTMLCodeStyleSettings Node count: ',
          xml_file_ops_instance.get_node_count('HTMLCodeStyleSettings'))
