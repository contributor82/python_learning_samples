...
class StringPatternMatching:
    ...
    def regex_findall(self) -> list[str | int]:
        ...
        result_non_overlapping_strings: list[str| int] = regularExpression.findall(r'\bf[a-z]*','which foot or hand fell fastest')
    ...
    def regex_sub(self) -> str:
        ...
        result: str = regularExpression.sub(r'(\b[a-z]+) \1', r'\1', 'cat in the the hat')
        return result
    ...
    def is_digit_string(self, input_str: str) -> bool:
        ...
        result: bool = False
        #[0-9] OR \d
        is_digit_pattern_match: regularExpression.Match[str] | None = regularExpression.match('[0-9]', input_str)
    ...
    def is_non_digit_string(self, input_str: str) -> bool:
        ...
        result = False
        #[^0-9] OR \D
        is_non_digit_pattern_match: regularExpression.Match[str] | None = regularExpression.match('[^0-9]', input_str)
    ...
    def is_alphanumeric(self, input_str: str) -> bool:
        ...
        result = False
        #[a-zA-Z0-9_] OR \w
        is_alphanumeric_pattern_match: regularExpression.Match[str] | None = regularExpression.match('[a-zA-Z0-9_]', input_str)
    ...
    def is_non_alphanumeric(self, input_str: str) -> bool:
        ...
        result = False
        #[^a-zA-Z0-9_] OR \w
        is_non_alphanumeric_pattern_match: regularExpression.Match[str] | None = regularExpression.match('[^a-zA-Z0-9_]', input_str)
    ...
    def is_string_prefix_with(self, prefix: str, input_str: str) -> bool:
         ...
         is_str_prefix_with_pattern_match: regularExpression.Match[str] | None = regularExpression.search(prefix_str, input_str)
    ...
    def detect_double_words(self, input_str: str) -> str:
        ...
        final_str: str | None = ""
        try:
            searchPattern: regularExpression.Pattern[str] = regularExpression.compile(r'\b(\w+)\s+\1\b')
            result : regularExpression.Match[str] | None = searchPattern.search(input_str)
            final_str = result.group()
        except Exception as ex:
            final_str = ex.__str__()
        return final_str
