...
class ProdClass:
    ...
    def __init__(self) -> None:
        """ Initializing Magic Mock method reference """
        # Without adding method reference in initialization,
        # causes attribute-defined-outside-error warning
        self.method = MagicMock(return_value=4) # type: ignore
